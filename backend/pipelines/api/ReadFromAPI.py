...
from backend.pipelines.api.YoutubeClient import get_playlists,get_playlist_tracks,get_video_stats
from backend.pipelines.api.ItunesClient import get_genre
    ...
    def process(self,element):
        ...
        for playlist in playlists:
            ...
            for i in range(0,len(video_ids),50):
                ...
                stats_lookup.update(self._retry_request(lambda:get_video_stats(batch_ids)))
            ...
            for track in track_rows:
                ...
                if key in self.genre_cache:
                    ...
                    genre,artist_name,country,collection_name,collection_id,trackTimeMillis=self._retry_request(lambda:get_genre(track_title))
