...
def derive_fields(record: dict) -> dict:
    ...
    if raw_millis in (None, ""):
        ...
        try:
            ...
            logger.warning(f"Invalid trackTimeMillis: {raw_millis!r}, defaulting to 0")
            track_millis = 0
...
def validate_record(record: dict, required_columns: list):
